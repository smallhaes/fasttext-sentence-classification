...
class TestFasttextScore(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.base_path = Path(__file__).parent / 'fasttext_score'

    def prepare_inputs(self) -> dict:
        # Change to your own inputs
        return {
            'trained_model_dir': str(self.base_path / 'inputs' / 'trained_model_dir'),
            'test_data_dir': str(self.base_path / 'inputs' / 'test_data_dir'),
    ...
    def prepare_outputs(self) -> dict:
        ...
        return {'model_testing_result': str(self.base_path / 'outputs' / 'model_testing_result')}
