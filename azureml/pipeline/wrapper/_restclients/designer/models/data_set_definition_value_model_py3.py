...
class DataSetDefinitionValueModel(DataSetDefinitionValue):
    ...
    def __init__(self, *, literal_value=None, data_set_reference=None, saved_data_set_reference=None, **kwargs) -> None:
        super(DataSetDefinitionValueModel, self).__init__(literal_value=literal_value, data_set_reference=data_set_reference, saved_data_set_reference=saved_data_set_reference, **kwargs)
