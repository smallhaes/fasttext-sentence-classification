...
class DataReferenceAzureSqlDatabaseReference(AzureDatabaseReference):
    ...
    def __init__(self, *, table_name: str=None, sql_query: str=None, stored_procedure_name: str=None, stored_procedure_parameters=None, aml_data_store_name: str=None, **kwargs) -> None:
        super(DataReferenceAzureSqlDatabaseReference, self).__init__(table_name=table_name, sql_query=sql_query, stored_procedure_name=stored_procedure_name, stored_procedure_parameters=stored_procedure_parameters, aml_data_store_name=aml_data_store_name, **kwargs)
