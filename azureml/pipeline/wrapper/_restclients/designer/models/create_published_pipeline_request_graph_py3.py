...
class CreatePublishedPipelineRequestGraph(GraphDraftEntity):
    ...
    def __init__(self, *, module_nodes=None, dataset_nodes=None, edges=None, entity_interface=None, graph_layout=None, created_by=None, last_updated_by=None, default_compute=None, default_datastore=None, id: str=None, etag: str=None, created_date=None, last_modified_date=None, **kwargs) -> None:
        super(CreatePublishedPipelineRequestGraph, self).__init__(module_nodes=module_nodes, dataset_nodes=dataset_nodes, edges=edges, entity_interface=entity_interface, graph_layout=graph_layout, created_by=created_by, last_updated_by=last_updated_by, default_compute=default_compute, default_datastore=default_datastore, id=id, etag=etag, created_date=created_date, last_modified_date=last_modified_date, **kwargs)
