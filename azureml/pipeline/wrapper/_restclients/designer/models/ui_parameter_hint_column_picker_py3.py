...
class UIParameterHintColumnPicker(UIColumnPicker):
    ...
    def __init__(self, *, column_picker_for: str=None, column_selection_categories=None, single_column_selection: bool=None, **kwargs) -> None:
        super(UIParameterHintColumnPicker, self).__init__(column_picker_for=column_picker_for, column_selection_categories=column_selection_categories, single_column_selection=single_column_selection, **kwargs)
