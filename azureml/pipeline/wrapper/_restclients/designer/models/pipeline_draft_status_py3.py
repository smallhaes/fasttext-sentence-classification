...
class PipelineDraftStatus(PipelineStatus):
    ...
    def __init__(self, *, status_code=None, run_status=None, status_detail: str=None, start_time=None, end_time=None, **kwargs) -> None:
        super(PipelineDraftStatus, self).__init__(status_code=status_code, run_status=run_status, status_detail=status_detail, start_time=start_time, end_time=end_time, **kwargs)
