...
class GraphDraftEntityCreatedBy(CreatedBy):
    ...
    def __init__(self, *, user_object_id: str=None, user_tenant_id: str=None, user_name: str=None, **kwargs) -> None:
        super(GraphDraftEntityCreatedBy, self).__init__(user_object_id=user_object_id, user_tenant_id=user_tenant_id, user_name=user_name, **kwargs)
