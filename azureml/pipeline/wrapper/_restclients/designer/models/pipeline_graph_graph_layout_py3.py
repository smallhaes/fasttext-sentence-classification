...
class PipelineGraphGraphLayout(GraphLayout):
    ...
    def __init__(self, *, node_layouts=None, id: str=None, etag: str=None, created_date=None, last_modified_date=None, **kwargs) -> None:
        super(PipelineGraphGraphLayout, self).__init__(node_layouts=node_layouts, id=id, etag=etag, created_date=created_date, last_modified_date=last_modified_date, **kwargs)
