...
class PipelineGraphSubPipelinesInfo(SubPipelinesInfo):
    ...
    def __init__(self, *, sub_graph_info=None, node_id_to_sub_graph_id_mapping=None, sub_pipeline_definition=None, **kwargs) -> None:
        super(PipelineGraphSubPipelinesInfo, self).__init__(sub_graph_info=sub_graph_info, node_id_to_sub_graph_id_mapping=node_id_to_sub_graph_id_mapping, sub_pipeline_definition=sub_pipeline_definition, **kwargs)
