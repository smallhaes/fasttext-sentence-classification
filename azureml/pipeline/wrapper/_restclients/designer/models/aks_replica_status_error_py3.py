...
class AKSReplicaStatusError(ModelManagementErrorResponse):
    ...
    def __init__(self, *, code: str=None, status_code: int=None, message: str=None, details=None, correlation=None, **kwargs) -> None:
        super(AKSReplicaStatusError, self).__init__(code=code, status_code=status_code, message=message, details=details, correlation=correlation, **kwargs)
