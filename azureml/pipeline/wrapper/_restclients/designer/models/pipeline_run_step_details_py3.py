...
class PipelineRunStepDetails(Model):
    ...
    :param snapshot_info:
    :type snapshot_info: ~designer.models.PipelineRunStepDetailsSnapshotInfo
    """
    ...
    _attribute_map = {
        ...
        'snapshot_info': {'key': 'snapshotInfo', 'type': 'PipelineRunStepDetailsSnapshotInfo'},
    }

    def __init__(self, *, run_id: str=None, target: str=None, status=None, status_detail: str=None, parent_run_id: str=None, start_time=None, end_time=None, is_reused: bool=None, logs=None, outputs=None, snapshot_info=None, **kwargs) -> None:
