...
class TestTrain2(unittest.TestCase):
    ...
    def test_module_from_func(self):
        # This test calls train2 from cmd line arguments.
        local_module = Module.from_func(self.workspace, train2)
        module = local_module()
    ...
    def test_module_func(self):
        # This test calls train2 from parameters directly.
        result = train2(**self.prepare_arguments())
